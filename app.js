...
const SessionLock = (() => {
  ...
  function notifyBlockedSave() {
    ...
    const who = (holder && holder.holderName) ? holder.holderName : 'another user';
    toast(`${t('Read-only:', 'قراءة فقط:')} ${t('session held by', 'الجلسة بحوزة')} ${who}. ${myRole() === 'admin' ? t('Use “Take over” to edit.', 'استخدم «استلام» للتعديل.') : t('Ask an admin.', 'اطلب المشرف.')}`, 'error');
    renderBanner();
  }
