...
const SEED_VERSION = '2026-06-08-v245-attended-respects-day'
...
const ROUTES = {
  ...
  families:   { label: 'Families',   icon: '👨‍👩‍👧', section: 'Main' },
  ...
  campmembers: { label: 'Camp Members', icon: '🚌', section: 'Main' },
  ...
  advice:     { label: 'Coach Advice', icon: '💬', section: 'Main' },
  ...
  danger:     { label: 'Danger Zone', icon: '⚠️', section: 'Settings', adminOnly: true },
...
function renderSidebar() {
  ...
  const SECTION_AR = { Main: 'الرئيسية', Finance: 'المالية', Insights: 'التقارير', System: 'النظام', Settings: 'الإعدادات' };
