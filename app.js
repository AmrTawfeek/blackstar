...
const SEED_VERSION = '2026-06-08-v272-camp-group-auto'
...
const ROUTES = {
  ...
  campimport: { label: 'Import Schedule', icon: '📋', section: 'Summer Camp', adminOnly: true },
