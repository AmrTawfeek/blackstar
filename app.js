...
const ROUTES = {
  ...
  campclosure: { label: 'Camp Closure', icon: '🏁', section: 'Summer Camp', adminOnly: true },   // v6.470 — switch/refund active camp members at close
