...
function renderSidebar() {
  ...
  const sections = ['Main','Membership','Engagement','Activities','Attendance','Advice','Summer Camp','Team & Sports','Finance','Shop','Insights','System'];
