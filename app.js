...
const SEED_VERSION = '2026-06-06-v181-attendance-fixes';
...
function maybeShowBackupReminder() {
  ...
  if (now - last < 7 * DAY) return;              // backed up recently
  if (now - snooze < 3 * DAY) return;           // recently snoozed
  ...
  bar.innerHTML = `
    <div style="display:flex;align-items:flex-start;gap:10px">
      ...
      <div style="flex:1;min-width:0">
        <div style="font-weight:600;margin-bottom:2px">Time for a backup?</div>
        <div style="color:var(--text-dim);font-size:12px;line-height:1.4">${msg}</div>
        <div style="display:flex;gap:8px;margin-top:10px">
          <button class="btn primary sm" id="backup-reminder-now">💾 Back up now</button>
