...
function _dedupeSubsGuard() {
  let collapsed = 0, membersHit = 0;
  for (const m of (state.members || [])) {
    const subs = m && m.subscriptions;
    if (!Array.isArray(subs) || subs.length < 2) continue;
