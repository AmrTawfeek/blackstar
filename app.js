...
const APP_VERSION = '6.246.1';   // multi-user backend + invoicing fixes; 6.242-6.244 revenue by SPORT START MONTH + per-payment sport tag; 6.245 UI declutter; 6.246.0 attendance date-active subscription + Invoices From/To range; 6.246.1 renewal invoice lands in the RENEWAL month (not the member's original enrolment month) — lineSportStartMonth picks the sub matching the invoice's own month, and renewal invoices stamp billMonth
