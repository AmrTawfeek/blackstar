...
function renderSidebar() {
  ...
  const SECTION_AR = { Main: 'الرئيسية', Membership: 'العضوية', Engagement: 'التواصل', Activities: 'الأنشطة', Advice: 'النصائح', 'Summer Camp': 'المعسكر الصيفي', 'Team & Sports': 'الفريق والرياضات', Finance: 'المالية', Shop: 'المتجر', Insights: 'التقارير', System: 'النظام' };
