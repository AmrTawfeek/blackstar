...
const APP_VERSION = '6.244.1';   // multi-user backend + invoicing fixes; 6.242.0 revenue by SPORT START MONTH; 6.243.x Fix-invoice-totals + inline amount + Refund + Cash-Collected; 6.244.0 PER-PAYMENT SPORT TAG (exact per-month Paid/Due); 6.244.1 INVOICES screen whole-month view now shows each invoice's month SHARE + month-scoped Paid/Due (matches Transactions; no more full amount double-counted across months)
