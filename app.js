...
function renderSidebar() {
  ...
  langBtn.innerHTML = [['en', 'English'], ['ar', 'العربية'], ['fr', 'Français']]
  ...
  langBtn.style.cssText = 'background:var(--surface-2);border:1px solid var(--border);cursor:pointer;font-size:12px;font-weight:600;padding:6px 8px;border-radius:8px;color:var(--text);margin-left:4px';
