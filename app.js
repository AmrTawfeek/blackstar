...
const APP_VERSION = '6.242.0';   // multi-user backend + invoicing fixes; 6.239.1 split-payment crash; 6.240.0 frozen-commission; 6.242.0 revenue by SPORT START MONTH (each sport's fee counts in the month it starts; invoice spans both months; payment dates stored but do not move revenue; commission stays on invoice month)
