...
async function withCloudConfirm(opts) {
  ...
  popup({
    ...
    body: `<div style="text-align:center;padding:8px 0">
        <div style="font-size:46px;line-height:1">⚠️</div>
        <div style="font-size:16px;font-weight:800;color:var(--red);margin-top:8px">${escapeHtml(t('NOT saved to the cloud', 'لم يُحفظ في السحابة'))}</div>
