...
function _campTargetForSub(sub) {
  ...
  if (!priceRow) {
    ...
    // Match by business-day count first, then legacy calendar days.
    priceRow = (DEFAULT_SUMMER_CAMP_PRICES || []).find(p => campClassCount(p.days) === cls)
      || (DEFAULT_SUMMER_CAMP_PRICES || []).find(p => p.days === cls);
  }
